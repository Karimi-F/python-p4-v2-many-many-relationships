...
cascade='all, delete-orphan')
    ...
    projects = association_proxy('assignments', 'project',
                                 creator=lambda project_obj:
Assignment(project=project_obj))
...
# Relatonship mapping the project related assignments
...
back_populates='project', cascade='all, delete-orphan')
    ...
    employees = association_proxy('assignments', 'employee',
                                  creator=lambda 
employee_obj: Assignment(employee=employee_obj))
